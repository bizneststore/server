#!/bin/bash
##########################################################################
## Copyright (C) 2009-2023 L2J Sunrise                                  ##
##########################################################################
...
############################################
## License: GNU GPL                       ##
## E-mail: l2jsunrise@gmail.com           ##
## From "L2J-DataPack"                    ##
## Bug reports: http://l2jsunrise.com/    ##
############################################
trap finish 2
...
echo ""
echo "Installing Custom content."
for custom in $(ls sql/sunrise_sql_files/custom/*.sql);do 
	echo "Installing custom table: $custom"
	$MYG < $custom
done
clear
...
echo "visit http://www.l2jsunrise.com for more info about"
