...
public class PremiumVCmd implements IVoicedCommandHandler
{
	...
	{
		if (command.startsWith("premium") || command.startsWith("platinum") || command.startsWith("gold") || command.startsWith("account"))
		{
			...
			if (activeChar.isPremium())
			{
				...
				html3.append("<tr><td>Gold Buffs: <font color=\"LEVEL\">Enchanted buffs from npc buffers and " + Math.round(prBuffScheme - normalBuffScheme) + " extra buff schemes<br1></font></td></tr>");
			...
			else if (activeChar.isPlatinum())
			{
				...
				html3.append("<tr><td>Buffer: <font color=\"LEVEL\">Unique .buffer command<br1></font></td></tr>");
				html3.append("<tr><td>Platinum Buffs: <font color=\"LEVEL\">Enchanted buffs from npc buffers and " + Math.round(plBuffScheme - normalBuffScheme) + " extra buff schemes<br1></font></td></tr>");
				html3.append("<tr><td>Expires: <font color=\"00A5FF\">" + String.valueOf(format.format(_end_prem_date)) + "</font></td></tr>");
				html3.append("<tr><td>Current Date: <font color=\"70FFCA\">" + String.valueOf(format.format(System.currentTimeMillis())) + "<br><br></font></td></tr>");
				html3.append("<tr><td><font color=\"LEVEL\"><center>Premium Info & Rules<br1></font></center></td></tr>");
				html3.append("<tr><td><font color=\"70FFCA\">1. Premium Accounts CAN NOT BE TRANSFERED.<br1></font></td></tr>");
