...
import l2r.features.sellBuffEngine.utils.Utils;
...
public class L2PcInstanceAction implements IActionHandler
{
	...
	public boolean action(L2PcInstance activeChar, L2Object target, boolean interact)
	{
		...
		else if (interact)
		{
			...
			// Check if target is buff seller
			// if is seller try to interact with seller
			if (Utils.tryInteract(activeChar, target))
			{
				// Do nothing here already handled
			}
