	...
	public final String onKill(L2Npc npc, L2PcInstance player, boolean isSummon)
	{
		if (npc.isAttackable())
		{
			...
			if (npc instanceof L2RaidBossInstance)
			{
				...
				additionalDrops.add(new DropDetails(49, 58, new DropItem(40013, 1, 10, 70))); // B GRADE FRAGMENTS
				additionalDrops.add(new DropDetails(59, 75, new DropItem(40014, 1, 10, 70))); // A
				additionalDrops.add(new DropDetails(72, 80, new DropItem(40015, 1, 10, 60))); // S
				additionalDrops.add(new DropDetails(78, 83, new DropItem(40016, 1, 10, 50))); // S80
				additionalDrops.add(new DropDetails(80, 85, new DropItem(40017, 1, 10, 50))); // S84
