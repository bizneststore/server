...
public class MC_Show extends AbstractNpcAI
{
	...
	private void scheduleTimer()
	{
		...
		_log.info("Fantasy Isle: MC show starts at " + format.format(System.currentTimeMillis() + diff) + " and is scheduled each next 4 hours.");
		
		startQuestTimer("Start", diff, null, null);
	}
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		if (event.equalsIgnoreCase("Start"))
		{
			...
			startQuestTimer("Start", 14400000, null, null);
		}
