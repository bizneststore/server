...
public class Galate extends AbstractNpcAI
{
	...
	public Galate()
	{
		...
		if (hellboundLevel >= 0)
		{
			startQuestTimer("firstWarpgate", 5000, null, null, true);
			startQuestTimer("secondWarpgate", 5000, null, null, true);
			startQuestTimer("thirdWarpgate", 5000, null, null, true);
			startQuestTimer("fourthWarpgate", 5000, null, null, true);
			startQuestTimer("fifthWarpgate", 5000, null, null, true);
			startQuestTimer("lastWarpgate", 5000, null, null, true);
		}
	}
